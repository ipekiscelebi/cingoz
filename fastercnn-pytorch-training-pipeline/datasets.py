...
class CustomDataset(Dataset):
    ...
    def read_and_clean(self):
        ...
        for image_name in tqdm(self.all_images, total=len(self.all_images)):
            ...
            if possible_annot_name not in self.all_annot_paths:
                print(f"?? {possible_annot_name} not found... Removing {image_name}")
        ...
        if problematic_images:
            print("\n?? The following images have invalid bounding boxes and will be removed:")
    ...
    def load_image_and_labels(self, index):
        ...
        for member in root.findall('object'):
            ...
            if(xmin_final < 0):
                print("Problem at image:", image_path, "for member", member.find("id").text)
